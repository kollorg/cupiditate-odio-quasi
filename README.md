# @/jsonpath [![CircleCI](https://circleci.com/gh/kollorg/cupiditate-odio-quasi.svg?style=svg)](https://circleci.com/gh/kollorg/cupiditate-odio-quasi) 

[![npm (scoped)](https://img.shields.io/npm/v/@kollorg/cupiditate-odio-quasi?style=flat-square)](https://npmjs.com/package/@kollorg/cupiditate-odio-quasi)
...
```javascript
import { JSONPath } from '@kollorg/cupiditate-odio-quasi';
...
Install from npm:
```bash
$ npm install @kollorg/cupiditate-odio-quasi
```
